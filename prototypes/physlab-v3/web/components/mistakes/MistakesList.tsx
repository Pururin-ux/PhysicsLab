...
import { getTopWeaknesses } from "../../lib/learning/weakness-labels";
import { $appProgress, combineWeakTraps } from "../../lib/stores/progress-store";
...
export function MistakesList() {
  ...
  const weaknesses = getTopWeaknesses(combineWeakTraps(progress), MAX_WEAKNESSES);
        ...
        return (
          ...
          >
            ...
            <Button asChild size="sm" className="shrink-0">
              <Link href={practiceHrefForSkill(weakness.skillId)}>
                Потренировать это
              </Link>
            </Button>
          </Card>
