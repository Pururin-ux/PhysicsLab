...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-[100dvh] bg-[#08080A] flex items-center justify-center pt-14 px-6 relative">
      <div className="absolute top-[30%] left-[30%] w-[400px] h-[400px] bg-[#FFD700]/[0.03] rounded-full blur-[140px] pointer-events-none" />
      ...
      >
        <div className="text-center mb-8">
          <Mascot pose="smiling" size="sm" className="mx-auto mb-5" noFloat />
          <h1 className="font-heading text-[22px] sm:text-2xl font-bold text-white tracking-tight mb-1.5">
            Рада видеть тебя!
          </h1>
          <p className="text-[13px] text-white/40">Войди, чтобы продолжить обучение</p>
        </div>
        ...
        <div className="surface-elevated rounded-2xl p-7">
          ...
          <div className="mt-6 text-center">
            <p className="text-[13px] text-white/30">
              Нет аккаунта?{' '}
              <Link to="/register" className="text-[#FFD700] hover:text-[#FFCA00] font-medium transition-colors duration-200" data-testid="go-to-register">
                Зарегистрироваться
              </Link>
            </p>
          </div>
