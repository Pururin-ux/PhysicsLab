> **HISTORICAL — not a current requirement.** Preserved operating runbook; its persistence and deployment statements require a fresh owner review before use.
...
- Незавершённая смешанная тренировка видна на её стартовом экране: её можно
  продолжить или начать новый вариант. Новый вариант отбрасывает только эту
  незавершённую попытку; завершённый прогресс в localStorage сохраняется.
