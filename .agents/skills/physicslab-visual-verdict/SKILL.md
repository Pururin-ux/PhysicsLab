...
Supporting references supply craft criteria, not independent product direction
or a larger verification budget. Read only the criteria relevant to the selected
question; do not expand the evidence packet merely to fill a checklist.
