...
const accentClasses: Record<NonNullable<CompactHelpCardProps["accent"]>, string> = {
  ...
  gold: "border-l-feedback-warning/60 text-feedback-warning",
...
export function CompactHelpCard({
  ...
  return (
    ...
    >
      {/* Ярлык «Справка» убран: карточка и так открывается внутри панели
          справки, и заголовок дублировал её название. */}
