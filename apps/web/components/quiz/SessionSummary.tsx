...
const resultBodies: Record<ResultVariant, [string, string, string, string]> = {
  ...
  exam: [
    "Все семь тем этой тренировки в хорошей форме.",
    "Разбор ошибок ниже покажет, что повторить перед следующей тренировкой.",
    "В этой тренировке верна половина ответов. Разбери слабые места и возьми следующую тренировку.",
