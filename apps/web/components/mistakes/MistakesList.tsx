  ...
  return (
    <div
      className={cn(
        ...
        tone === "gold" && "border-feedback-warning/35",
    ...
    >
      <p
        className={cn(
          ...
          tone === "gold" && "text-feedback-warning",
  ...
  return (
    <Card className="grid min-h-[390px] overflow-hidden !p-0 lg:grid-cols-[minmax(0,.92fr)_minmax(360px,1.08fr)]">
      ...
      <div data-theme-preserve="dark" className="relative min-h-[280px] border-t border-white/[.1] bg-space-950 lg:min-h-full lg:border-l lg:border-t-0">
        <Image
          src="/art/production/topic-dynamics.webp"
          alt="Лабораторная модель тележки и блока для разбора сил"
          fill
          priority
      ...
      >
        <div
          className={cn(
            ...
            insight.tone === "gold" && "bg-feedback-warning",
