...
export const weaknessCopyBySkill: Partial<Record<SkillId, {
  ...
  "coulomb-force": {
    title: "Закон Кулона",
    hint: "Сначала ==СИ==: мкКл в Кл, см в метры. Потом $F = k\\frac{q_1 q_2}{r^2}$.",
  },
  "ampere-force": {
    title: "Сила Ампера",
    hint: "Три множителя подряд: $F = ==BIL==$, длина — в метрах.",
  },
  "lorentz-force": {
    title: "Сила Лоренца",
    hint: "Перемножь ==заряд, скорость и индукцию==: $F = qvB$.",
  },
  "magnetic-flux": {
    title: "Магнитный поток",
    hint: "Поток — это $==BS==$: индукция умножить на площадь.",
  },
  "emf-induction": {
    title: "ЭДС индукции",
    hint: "Считай ==скорость изменения потока==: $\\Delta\\Phi$ разделить на $\\Delta t$.",
  },
  "oscillation-period": {
    title: "Период и частота",
    hint: "Сначала назови, что ищешь: $T = \\frac{t}{N}$ или $\\nu = \\frac{N}{t}$.",
  },
  "wave-speed": {
    title: "Скорость волны",
    hint: "Скорость = ==длина волны × частота==, а не их сумма.",
  },
  "wave-length": {
    title: "Длина волны",
    hint: "Длина волны = ==скорость / частота==.",
  },
  "echo-distance": {
    title: "Эхо и эхолот",
    hint: "Сигнал прошёл путь ==дважды==: найденный путь дели пополам.",
  },
  "photon-energy": {
    title: "Энергия фотона",
    hint: "$E = h\\nu$: ==степени десятки== перемножай отдельно от мантисс.",
  },
  "photoelectric-effect": {
    title: "Фотоэффект",
    hint: "Запиши $h\\nu = A + E_{\\text{к}}$ и ==вырази искомое==: работа выхода вычитается.",
  },
  "radioactive-decay": {
    title: "Распад ядер",
    hint: "Сначала ==число периодов==, потом дели остаток пополам столько же раз.",
  },
  "nucleon-count": {
    title: "Состав ядра",
    hint: "Нейтроны = ==массовое число минус зарядовое==, а не одно из данных чисел.",
  },
  "lens-image-height": {
