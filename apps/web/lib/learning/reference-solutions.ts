...
const solutions = {
  ...
  "vt-area": {
    ...
    check: {
      explanation: "Здесь скорость не меняет знак, поэтому средняя путевая скорость 4 м/с лежит между 2 и 6 м/с; за 4 с это даёт 16 м.",
    },
    typicalMistake: {
  ...
  "average-speed-segments": {
    ...
    question: "Найдите среднюю путевую скорость.",
    givens: [
    ...
    model: {
      explanation: "Средняя путевая скорость описывает весь путь целиком: нужно сложить пройденные расстояния и разделить их на полное время движения.",
    },
    law: {
      explanation: "Средняя путевая скорость — отношение общего пути к общему времени.",
    ...
    answer: {
      expression: { latex: "v_{\\text{ср}}=8\\,\\text{м/с}", accessibleText: "средняя путевая скорость равна 8 метров в секунду" },
      sentence: "Средняя путевая скорость равна 8 м/с.",
    },
    check: {
