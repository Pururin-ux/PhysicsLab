...
const explanationByFamily: Partial<Record<TemplateId, ExactExplanation>> = {
  ...
  "ship-payload": { href: "/learn/ships-and-ballooning?practice=ship-payload", chapterId: "ships-and-ballooning", label: "Как ватерлиния ограничивает массу груза" },
  ...
  "uniform-coordinate-law": { href: "/learn/uniform-rectilinear-motion?practice=uniform-coordinate-law", chapterId: "uniform-rectilinear-motion", label: "Как знак скорости меняет координату" },
  ...
  "gravitation-distance": { href: "/learn/universal-gravitation?practice=gravitation-distance", chapterId: "universal-gravitation", label: "Почему расстояние меняет притяжение в квадрате" },
  "weight-lift": { href: "/learn/weight-weightlessness-overload?practice=weight-lift", chapterId: "weight-weightlessness-overload", label: "Почему ускорение меняет показание весов" },
  "torque-balance": { href: "/learn/force-moment-and-equilibrium?practice=torque-balance", chapterId: "force-moment-and-equilibrium", label: "Как плечо силы определяет поворот" },
  "movable-pulley": { href: "/learn/simple-machines-levers-pulleys?practice=movable-pulley", chapterId: "simple-machines-levers-pulleys", label: "Почему подвижный блок уменьшает силу вдвое" },
  "impulse-momentum": { href: "/learn/momentum-and-systems?practice=impulse-momentum", chapterId: "momentum-and-systems", label: "Как сила за время изменяет импульс" },
  "inelastic-collision-speed": { href: "/learn/momentum-conservation-and-reactive-motion?practice=inelastic-collision-speed", chapterId: "momentum-conservation-and-reactive-motion", label: "Почему при сцеплении складывают импульсы" },
  "work-at-angle": { href: "/learn/work-and-power-vectors?practice=work-at-angle", chapterId: "work-and-power-vectors", label: "Как направление силы определяет работу" },
  ...
  "vt-slope": { href: "/learn/uniformly-accelerated-motion?practice=vt-slope", chapterId: "uniformly-accelerated-motion", label: "Как найти ускорение по графику скорости" },
  "vt-area": { href: "/learn/uniformly-accelerated-motion?practice=vt-area", chapterId: "uniformly-accelerated-motion", label: "Как найти перемещение по графику скорости" },
  "rotation-frequency": { href: "/learn/circular-motion-kinematics?practice=rotation-frequency", chapterId: "circular-motion-kinematics", label: "Как связаны число оборотов, время и частота" },
  "centripetal-acceleration": { href: "/learn/centripetal-acceleration?practice=centripetal-acceleration", chapterId: "centripetal-acceleration", label: "Почему ускорение направлено к центру" },
  ...
  "friction-force": { href: "/learn/friction-and-medium-resistance?practice=friction-force", chapterId: "friction-and-medium-resistance", label: "Как прижим определяет силу трения" },
  "free-fall": { href: "/learn/motion-under-gravity?practice=free-fall", chapterId: "motion-under-gravity", label: "Почему путь при падении растёт как квадрат времени" },
  "projectile-components": { href: "/learn/projectile-motion-components?practice=projectile-components", chapterId: "projectile-motion-components", label: "Как один бросок разделяется на движение по двум осям" },
  ...
  "conductor-resistance": { href: "/learn/conductor-resistance?practice=conductor-resistance", chapterId: "conductor-resistance", label: "Как материал и размеры задают сопротивление" },
  "resistor-network": { href: "/learn/series-and-parallel-circuits?practice=resistor-network", chapterId: "series-and-parallel-circuits", label: "Как соединение меняет сопротивление цепи" },
  "electric-power": { href: "/learn/electric-work-and-power?practice=electric-power", chapterId: "electric-work-and-power", label: "Чем мощность отличается от переданной энергии" },
  "elementary-charge-count": { href: "/learn/electric-charge-and-atom?practice=elementary-charge-count", chapterId: "electric-charge-and-atom", label: "Почему заряд изменяется целыми порциями" },
  "molecule-count-from-mass": { href: "/learn/molecular-mass-and-amount?practice=molecule-count-from-mass", chapterId: "molecular-mass-and-amount", label: "Как масса образца связана с числом молекул" },
  "particle-concentration": { href: "/learn/macro-micro-parameters-ideal-gas?practice=particle-concentration", chapterId: "macro-micro-parameters-ideal-gas", label: "Как число частиц в объёме связано с давлением газа" },
  "molecular-kinetic-energy": { href: "/learn/thermal-equilibrium-and-temperature?practice=molecular-kinetic-energy", chapterId: "thermal-equilibrium-and-temperature", label: "Почему температура измеряет среднюю энергию частиц" },
  "ideal-gas-state": { href: "/learn/ideal-gas-state-equation?practice=ideal-gas-state", chapterId: "ideal-gas-state-equation", label: "Как рассчитать одно состояние идеального газа" },
  "gas-state-ratio": { href: "/learn/ideal-gas-state-equation?practice=gas-state-ratio", chapterId: "ideal-gas-state-equation", label: "Что сохраняется при переходе газа между состояниями" },
  "ideal-gas-isoprocess": { href: "/learn/isoprocesses-ideal-gas?practice=ideal-gas-isoprocess", chapterId: "isoprocesses-ideal-gas", label: "Как постоянный параметр задаёт закон процесса" },
  "solid-structure-properties": { href: "/learn/solid-structure-and-properties?practice=solid-structure-properties", chapterId: "solid-structure-and-properties", label: "Как строение твёрдого тела задаёт его свойства" },
  "liquid-structure-properties": { href: "/learn/liquid-structure-and-properties?practice=liquid-structure-properties", chapterId: "liquid-structure-and-properties", label: "Как строение жидкости объясняет текучесть и капли" },
  "vapor-dynamic-equilibrium": { href: "/learn/evaporation-condensation-saturated-vapor?practice=vapor-dynamic-equilibrium", chapterId: "evaporation-condensation-saturated-vapor", label: "Как два потока создают насыщенный пар" },
  "relative-humidity-pressure": { href: "/learn/air-humidity-and-dew-point?practice=relative-humidity-pressure", chapterId: "air-humidity-and-dew-point", label: "Как температура меняет относительную влажность" },
  "magnetic-field-direction": { href: "/learn/magnetic-field-and-electromagnet?practice=magnetic-field-direction", chapterId: "magnetic-field-and-electromagnet", label: "Как ток задаёт направление магнитного поля" },
  ...
  "plane-mirror-separation": { href: "/learn/plane-mirror-image?practice=plane-mirror-separation", chapterId: "plane-mirror-image", label: "Где находится мнимое изображение" },
  "shadow-and-penumbra": { href: "/learn/light-sources-and-shadows?practice=shadow-and-penumbra", chapterId: "light-sources-and-shadows", label: "Как размер источника меняет границу тени" },
  "refraction-direction": { href: "/learn/refraction-of-light?practice=refraction-direction", chapterId: "refraction-of-light", label: "Куда поворачивает луч на границе сред" },
  "lens-optical-power": { href: "/learn/lenses-and-optical-power?practice=lens-optical-power", chapterId: "lenses-and-optical-power", label: "Как фокусное расстояние задаёт оптическую силу" },
  "lens-image-properties": { href: "/learn/images-in-thin-lenses?practice=lens-image-properties", chapterId: "images-in-thin-lenses", label: "Как положение предмета меняет изображение" },
  "vision-correction": { href: "/learn/vision-defects-and-correction?practice=vision-correction", chapterId: "vision-defects-and-correction", label: "Как положение фокуса определяет линзу очков" },
