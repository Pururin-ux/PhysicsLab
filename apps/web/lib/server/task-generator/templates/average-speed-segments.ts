...
export const averageSpeedSegmentsBlueprint: TaskBlueprint = {
  ...
  skill: "Средняя путевая скорость",
  topic: "Кинематика",
  group: "kinematics",
  ...
  textTemplate: (p) =>
    `${subjectFor(p)} двигался ${p.t1} с со скоростью ${p.v1} м/с, затем еще ${p.t2} с со скоростью ${p.v2} м/с. Найдите среднюю путевую скорость за всё время движения.`,
  ...
  trap: "Средняя путевая скорость считается как весь путь, делённый на всё время, а не как среднее арифметическое скоростей.",
  coachLines: {
    correct: () =>
      "Верно. Для средней путевой скорости нужны весь путь и всё время движения.",
    wrong: (_p, selected, correct) =>
      `Проверь, не усреднил ли ты скорости напрямую. Средняя путевая скорость равна всему пути, делённому на всё время: ${formatAnswerValue(correct)} м/с, а не ${formatAnswerValue(selected)} м/с.`,
  },
  constraints: [
    (p) => p.v1 !== p.v2,
    (p) => p.t1 !== p.t2,
