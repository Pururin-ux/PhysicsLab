...
const stories = [
  ...
  {
    text: (p: Params) =>
      `Катер движется относительно воды со скоростью ${p.v1} м/с строго поперёк потока. Течение сносит его со скоростью ${p.v2} м/с. Найдите модуль скорости катера относительно берега.`,
    subject: "катера",
  },
  {
    text: (p: Params) =>
      `Дрон летит относительно воздуха со скоростью ${p.v1} м/с перпендикулярно ветру. Ветер сносит его со скоростью ${p.v2} м/с. Найдите модуль скорости дрона относительно земли.`,
    subject: "дрона",
  },
] as const;
